...
public class AddFaceAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    protected void onPreExecute() {
        ...
        AddFaceActivity.layoutInflater = (LayoutInflater) MyContext.getContext().getSystemService(MyContext.getContext().LAYOUT_INFLATER_SERVICE);
    ...
    protected String doInBackground(String... urls) {
        ...
        try {
            ...
            if(conn_detect.getResponseCode() == 200) {
                ...
                if(facetoken != ""){
                    AddFaceActivity.result_tv.setText("找到人臉");
                }else{
                    AddFaceActivity.result_tv.setText("找不到人臉");
                }

                StringBuilder stringBuilder = new StringBuilder();
                try{
                    URL url = new URL(Url.serverUrl + "?fa=" + facetoken + "&na=" + AddFaceActivity.account);
            ...
            e.printStackTrace();
            AddFaceActivity.result_tv.setText("新增失敗，請檢查照片是否有人頭");
            //return "Unable to retrieve web page. URL may be invalid.";
        }
        return null;
    }
    ...
    protected void onPostExecute(String result) {
        ...
        if(result != null){
            if(result.equals("saveok")){
                Toast.makeText(MyContext.getContext(), "新增人臉成功", Toast.LENGTH_SHORT).show();

                AddFaceActivity.instance.finish();
            }
            else{
                Toast.makeText(MyContext.getContext(), "新增人臉失敗", Toast.LENGTH_SHORT).show();
            }
        }
        else{
            Toast.makeText(MyContext.getContext(), "新增人臉失敗", Toast.LENGTH_SHORT).show();
    ...
    private void detect(HttpsURLConnection conn){
        try {
            ...
            detectMap.put("image_base64", AddFaceActivity.getImgBase64());
